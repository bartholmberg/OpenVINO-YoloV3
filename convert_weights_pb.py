...
#tf.compat.v1.app.flags.DEFINE_integer('size', 416, 'Image size')
tf.compat.v1.app.flags.DEFINE_integer('size', 640, 'Image size')
...
def main(argv=None):
    ...
    #inputs = tf.compat.v1.placeholder(tf.float32, [None, 1280, 640,3], "inputs")
